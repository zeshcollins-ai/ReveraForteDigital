...
import { 
  X, Search, Share2, FileText, Target, Users, UserPlus, 
...
const DigitalMarketingModal = ({ isOpen, onClose }: ModalProps) => {
  ...
  const services = [
    {
      ...
      description: "Dominate search rankings with our data-driven approach",
      items: [
      ...
      stats: ["↑ 230% organic traffic", "↓ 40% bounce rate"]
    },
    {
      icon: Share2,
      title: "Social Media Marketing",
      description: "Build authentic connections at scale",
      items: [
        "Platform strategy",
        "Community growth",
      ...
      stats: ["3.5x engagement", "20% lower CPA"]
    },
    {
      icon: FileText,
      title: "Content Marketing",
      description: "Storytelling that converts",
      items: [
        "SEO content",
        "Video production",
        "Interactive content",
      ...
      stats: ["5x more leads", "3min avg. dwell time"]
    },
    {
      icon: Target,
              ...
              <div className="mt-12 pt-8 border-t border-gray-700/50">
                <button className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 to-cyan-600 p-px">
                  ...
                  <div className="relative flex items-center justify-center px-8 py-4 bg-gray-900 rounded-[11px]">
                    <span className="font-medium text-white mr-3">Schedule Free Consultation</span>
