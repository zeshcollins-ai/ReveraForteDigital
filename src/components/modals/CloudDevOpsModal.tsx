...
import { 
  X, Cloud, GitBranch, Code2, Box, BarChart, ArrowRight,
...
const CloudDevOpsModal = ({ isOpen, onClose }: ModalProps) => {
  ...
  const services = [
    {
      ...
      description: "Optimized cloud environments for your business",
      items: [
      ...
      stats: ["↓ 40% infrastructure costs", "99.99% availability"]
    },
    {
      icon: GitBranch,
      title: "CI/CD Pipeline Development",
      description: "Automated deployment workflows for faster releases",
      items: [
      ...
      stats: ["10x faster deployments", "↓ 90% deployment errors"]
    },
    {
      icon: Code2,
      title: "Infrastructure as Code (IaC)",
      description: "Codified infrastructure for consistency and reliability",
      items: [
      ...
      stats: ["100% reproducible environments", "↓ 70% provisioning time"]
    },
    {
      icon: Box,
      title: "Containerization",
      description: "Scalable container solutions for modern applications",
      items: [
      ...
      stats: ["5x improved scalability", "↑ 60% resource efficiency"]
    },
    {
      icon: BarChart,
      ...
      stats: ["↓ 50% incident response time", "99% issue detection"]
    },
    {
      icon: ArrowRight,
      title: "Cloud Migration Services",
      description: "Seamless transition from on-premise to cloud",
      items: [
      ...
      stats: ["↓ 30% operational costs", "↑ 45% performance"]
    }
  ];
              ...
              <div className="mt-12 pt-8 border-t border-gray-700/50">
                <button className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 to-cyan-600 p-px">
                  ...
                  <div className="relative flex items-center justify-center px-8 py-4 bg-gray-900 rounded-[11px]">
                    <span className="font-medium text-white mr-3">Schedule Infrastructure Consultation</span>
...
export default CloudDevOpsModal;