...
import { 
  X, Search, Target, Repeat, PenTool, BarChart2, 
...
const GoogleMetaAdsModal = ({ isOpen, onClose }: ModalProps) => {
  ...
  const services = [
    {
      ...
      description: "Targeted search and display advertising",
      items: [
      ...
      stats: ["↑ 320% ROAS", "↓ 40% cost per acquisition"]
    },
    {
      icon: Target,
      title: "Meta (Facebook & Instagram) Ads",
      description: "Social media campaigns that convert",
      items: [
        "Custom audience targeting",
        "Lookalike audience creation",
        "Instagram story ads",
        "Facebook feed campaigns"
      ],
      stats: ["2.5x engagement rate", "↑ 45% conversion rate"]
    },
    {
      icon: Repeat,
      title: "Remarketing Campaigns",
      description: "Re-engage visitors with personalized ads",
      items: [
        "Dynamic remarketing",
      ...
      stats: ["↑ 70% conversion lift", "4x ROI improvement"]
    },
    {
      icon: PenTool,
      title: "Ad Copywriting & Design",
      description: "Compelling creative that drives action",
      items: [
      ...
      stats: ["↑ 85% click-through rate", "↓ 30% bounce rate"]
    },
    {
      icon: BarChart2,
      ...
      items: [
        ...
        "Meta Business Suite reporting",
        "Conversion tracking setup",
        "Custom dashboard creation"
      ],
      stats: ["100% attribution clarity", "Weekly optimization"]
    }
  ];
              ...
              <div className="mt-12 pt-8 border-t border-gray-700/50">
                <button className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 to-cyan-600 p-px">
                  ...
                  <div className="relative flex items-center justify-center px-8 py-4 bg-gray-900 rounded-[11px]">
                    <span className="font-medium text-white mr-3">Get Your Ad Campaign Started</span>
...
export default GoogleMetaAdsModal;