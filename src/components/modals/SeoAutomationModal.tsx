...
import { 
  X, Search, Bell, FileText, Link2, Settings,
...
const SeoAutomationModal = ({ isOpen, onClose }: ModalProps) => {
  ...
  const services = [
    {
      ...
      stats: ["500+ keywords per report", "↑ 65% ranking efficiency"]
    },
    {
      icon: Bell,
      title: "SEO Monitoring & Alerts",
      description: "Real-time tracking of your search performance",
      items: [
      ...
      stats: ["24/7 monitoring", "15-min alert response"]
    },
    {
      icon: FileText,
      title: "Content Optimization Tools",
      description: "Automated content enhancement for better rankings",
      items: [
        "On-page SEO scoring",
      ...
      stats: ["↑ 40% content performance", "3x faster optimization"]
    },
    {
      icon: Link2,
      title: "Link Building Automation",
      description: "Streamlined backlink acquisition processes",
      items: [
      ...
      stats: ["↑ 200% outreach efficiency", "35% higher response rate"]
    },
    {
      icon: Settings,
      title: "Technical SEO Automation",
      description: "Automated audits and fixes for site health",
      items: [
      ...
      stats: ["90+ technical factors checked", "↓ 75% manual work"]
    }
  ];
              ...
              <div className="mt-12 pt-8 border-t border-gray-700/50">
                <button className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 to-cyan-600 p-px">
                  ...
                  <div className="relative flex items-center justify-center px-8 py-4 bg-gray-900 rounded-[11px]">
                    <span className="font-medium text-white mr-3">Automate Your SEO Strategy</span>
...
export default SeoAutomationModal;