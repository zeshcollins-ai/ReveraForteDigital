...
import { 
  X, Palette, Layout, Box, MousePointer, TestTube, 
  ChevronDown, ChevronUp, BarChart2, ArrowRight, Sparkles 
} from 'lucide-react';
...
const ProductDesignModal = ({ isOpen, onClose }: ModalProps) => {
  ...
  const services = [
    {
      ...
      description: "Creating intuitive user journeys and experiences",
      items: [
        "User research",
      ...
      stats: ["↑ 40% user satiinfoaction", "↓ 25% support tickets"]
    },
    {
      icon: Palette,
      ...
      stats: ["95% design consistency", "2x faster development"]
    },
    {
      icon: Box,
      ...
      stats: ["85% brand recognition", "3x brand recall"]
    },
    {
      icon: MousePointer,
      ...
      stats: ["↑ 35% engagement", "↓ 20% bounce rate"]
    },
    {
      icon: TestTube,
      title: "Prototyping & Testing",
      description: "Validate designs before development",
      items: [
        "Interactive prototypes",
        "Usability testing",
        "A/B testing",
      ...
      stats: ["60% fewer revisions", "4x ROI on testing"]
    }
  ];
              ...
              <div className="mt-12 pt-8 border-t border-gray-700/50">
                <button className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 to-cyan-600 p-px">
                  ...
                  <div className="relative flex items-center justify-center px-8 py-4 bg-gray-900 rounded-[11px]">
                    <span className="font-medium text-white mr-3">Request Design Consultation</span>
...
export default ProductDesignModal;